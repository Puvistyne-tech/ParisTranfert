/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 053abdf22865ccdddbb2d2d3f01c7f82)
// Runtime types generated with workerd@1.20251105.0 2025-03-25 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_APPWRITE_RESERVATIONS_COLLECTION_ID: string;
		NEXT_PUBLIC_APPWRITE_USERS_COLLECTION_ID: string;
		APPWRITE_SERVER_KEY: string;
		ADMIN_EMAIL: string;
		APP_URL: string;
		ASSETS: Fetcher;
	}
