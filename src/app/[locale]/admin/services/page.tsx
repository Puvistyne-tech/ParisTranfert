...
import { getServices, getCategories, createService, updateService, deleteService } from "@/lib/supabaseService";
      ...
      {filteredServices.length === 0 && !loading && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            {search || selectedCategory ? "Try adjusting your filters" : "Get started by creating a new service"}
          </p>
        </div>
      )}
