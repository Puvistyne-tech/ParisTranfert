...
import { getCategories, createCategory, updateCategory, deleteCategory } from "@/lib/supabaseService";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Manage service categories</p>
        </div>
      ...
      {categories.length === 0 && !loading && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400">Get started by creating a new category</p>
        </div>
      )}
